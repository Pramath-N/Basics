...
public:
        ...
        if (head == nullptr){
            ...
            if (!found){
                ...
                if(temp -> borrowed == true){
                    cout<<"\n\nThe book is currently borrowed so cannot delete its record";
                    cout << "\n\nEnter 0 to exit or any other key to continue: ";
                    string s;
                    while(s != "0") cin>>s;
                    return;
    ...
    void return_book(){
        ...
        if(book -> borrower_id != user_id){
            cout<<"\n\nWrong user id, book has been borrowed under different id, please check properly: ";
            cout << "\n\nEnter 0 to to return to main menu ";
            string s = "1";
